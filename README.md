...
You can find binaries of Datavyu available for Windows and OSX on [the release page]([http://datavyu.org/download/](https://github.com/databrary/datavyu/releases)).
